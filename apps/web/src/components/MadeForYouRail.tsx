        ...
        {picks.map((pick) => (
          <li key={pick.song.id}>
            <Link
              ...
              className="group/pick block overflow-hidden rounded-2xl border border-white/10 bg-black/40 transition hover:-translate-y-0.5 hover:border-accent-300/45 hover:shadow-2xl hover:shadow-accent-500/10"
