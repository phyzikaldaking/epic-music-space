...
export default function CityScene3D({ buildings }: Props) {
  ...
  useEffect(() => {
    ...
    async function initScene() {
      ...
      const ORB_DATA = [
        { pos: new Vector3(-22, 12, 14), color: new Color4(0.42, 0.36, 0.9, 0.6), dk: "DOWNTOWN_PRIME" },
        { pos: new Vector3(0, 16, -20),  color: new Color4(1, 0.84, 0, 0.6),      dk: "LABEL_ROW" },
        { pos: new Vector3(22, 10, 14),  color: new Color4(0, 0.96, 1, 0.6),      dk: "INDIE_BLOCKS" },
      ];
      ...
      for (const orb of ORB_DATA) {
        ...
        orbPs.color2 = new Color4(orb.color.r * 0.5, orb.color.g * 0.5, orb.color.b * 0.5, 0.3);
