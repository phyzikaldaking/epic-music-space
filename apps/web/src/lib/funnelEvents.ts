export const FUNNEL_EVENTS = {
  ...
  homeStudioTourStarted: "funnel_home_studio_tour_started",
  ...
  authSigninView: "funnel_auth_signin_view",
  authSigninAttempt: "funnel_auth_signin_attempt",
  authSigninFailure: "funnel_auth_signin_failure",
  authSigninSuccess: "funnel_auth_signin_success",
  authMagicLinkRequested: "funnel_auth_magic_link_requested",
  authOAuthStarted: "funnel_auth_oauth_started",
