  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hey! I'm the EMS AI assistant. I can help you discover songs to license, understand how the platform works, and answer questions about artists, Versus battles, and more. What would you like to know?",
    },
  ]);
    ...
    <div className="mx-auto flex h-[calc(100vh-80px)] max-w-3xl flex-col px-4 py-8">
      ...
      <form onSubmit={sendMessage} className="mt-4 flex gap-3">
        <input
          ...
          className="flex-1 rounded-xl border border-white/20 bg-white/5 px-4 py-2.5 text-sm placeholder:text-white/30 focus:outline-none focus:border-brand-500"
        />
        <button
          type="submit"
          disabled={!input.trim() || loading}
          className="rounded-xl bg-brand-500 px-5 py-2.5 text-sm font-semibold hover:bg-brand-600 transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Send
        </button>
      </form>
