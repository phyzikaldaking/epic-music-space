...
const snapshotSchema = z.object({
  ...
  selectedClipId: z.string().max(160).nullable().optional(),
  ...
  clips: z.array(z.unknown()).max(512).optional(),
  placedClips: z.array(z.unknown()).max(512).optional(),
  audioBuffers: z.array(z.unknown()).max(512).optional(),
  soundLibrary: z.array(z.unknown()).max(512).optional(),
  padAssignments: z.record(z.string(), z.unknown()).optional(),
  workspaceLayout: z.unknown().optional(),
  selectedKit: z.string().max(80).nullable().optional(),
  selectedInstrument: z.string().max(120).nullable().optional(),
