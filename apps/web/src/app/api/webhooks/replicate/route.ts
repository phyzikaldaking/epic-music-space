  ...
  try {
    ...
    await prisma.song.update({
      ...
      data: {
        ...
        // Cast to a plain object so Prisma accepts it as JSON. The struct
        // shape is preserved at runtime; only the static type changes.
        stemFiles: { ...stems } as Record<string, string>,
        hasStems: true,
        stemSeparationCompletedAt: new Date(),
