...
const INITIAL_LAYOUT: WorkspaceLayout = { layoutPreset: "producer", fullscreenPanel: null, splitView: "none", floatingPanels: [] };
...
export default function StudioWorkstationRecoveryClient() {
  ...
  const recovery = useStudioRecovery({ mode, selectedTrack, selectedClipId, bpm, bar: transport.bar, playing: transport.playing, tracks, clips, audioBuffers, workspaceLayout }, (payload) => {
