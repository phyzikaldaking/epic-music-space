...
const upgrades = [
  ...
  { title: "Multi-mic workflow readiness", detail: "Session flow prepared for wider source capture and review ergonomics.", status: "Live" },
  { title: "Transient-to-MIDI assistance", detail: "AI/analysis-driven pattern support pipeline for quicker groove extraction.", status: "Live" },
